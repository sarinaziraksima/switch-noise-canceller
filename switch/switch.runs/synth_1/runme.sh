...
HD_PWD='C:/Users/Apple/Desktop/vivado/switch/switch.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sw.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sw.tcl
